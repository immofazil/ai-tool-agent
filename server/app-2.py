...
class AutonomousAgent:
    def __init__(self):
        ...
        logger.info("Agent engine initialized successfully with 3 tools: ['get_weather', 'calculate', 'search_notes']")
        ...
        try:
            ...
            while True:
                ...
                if tool_name in AVAILABLE_TOOLS:
                    ...
                    response = self._safe_send_message(chat, function_response_payload)
                    ...
                    response = self._safe_send_message(chat, error_payload)
